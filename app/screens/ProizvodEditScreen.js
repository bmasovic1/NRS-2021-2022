...
function ProizvodEditScreen({ navigation }) {
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      setCijena(state.edit.proizvod.cijena.trim());
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TextInput
        ...
        style={styles.input}
        value={cijena}
        onChangeText={(cijena) => setCijena(cijena.trim())}
        onPress={(im) => setSNaziv(im)}
      ></TextInput>
      ...
      <View style={{ flexDirection: "row" }}>
        ...
        <View width="40%">
        <TouchableOpacity style={styles.button} onPress={()=> izmjenaProizvoda({nazivS,naziv,kolicina,jedinica, cijena})}>
