...
function ArtiklEdit({ route }){

  const {state, izmjenaArtikla, obrisiKorisnika} = useContext(AuthContext);
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={()=>izmjenaArtikla({kolicina, nazivProizvoda})} >
