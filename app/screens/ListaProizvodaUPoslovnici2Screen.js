...
const ListaProizvodaUPoslovnici2Screen = ({ navigation }) => {
  ...
  const ItemRender = ({ proizvod }) => (
    <ListItem 
      onPress={() =>navigation.navigate('DodajArtikl', {
        nazivProizvoda: proizvod.naziv,
        idDostave: proizvod.id,
        kolicinaProizvoda: proizvod.kolicina
      })}
      bottomDivider containerStyle={{ margin: 3 }}>
      <ListItem.Content>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.item2}>Proizvodi u poslovnici</Text>
...
export default ListaProizvodaUPoslovnici2Screen;
